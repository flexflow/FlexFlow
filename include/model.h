...
enum TaskIDs {
  ...
  // Python data loader
  PY_DL_4D_FLOAT_LOAD_ENTIRE_CPU_TASK_ID,
  PY_DL_2D_FLOAT_LOAD_ENTIRE_CPU_TASK_ID,
  PY_DL_2D_INT_LOAD_ENTIRE_CPU_TASK_ID,
  PY_DL_4D_FLOAT_LOAD_BATCH_GPU_TASK_ID,
  PY_DL_2D_FLOAT_LOAD_BATCH_GPU_TASK_ID,
  PY_DL_2D_INT_LOAD_BATCH_GPU_TASK_ID,
  // Custom tasks
