                    ...
                    Context ctx, Runtime* runtime)
{
  ...
  initialize_tensor_gradient_from_file(output_grad_file_path, batch_matmul_ret, ff, "float", 3);
...
{
  // std::cout << static_cast<std::underlying_type<TaskIDs>::type>(ZERO_INIT_TASK_ID) << std::endl;
  {
