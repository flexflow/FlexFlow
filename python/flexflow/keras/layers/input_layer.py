...
class InputLayer(Layer):
  def __init__(self, shape=None, batch_size=None, name=None, 
    ...
    output_tensor = Tensor(ffmodel=None, shape=shape, name=name, dtype=dtype, meta_only=True, **kwargs) 
...
def Input(shape=None, batch_size=None, name=None, 
          ...
          tensor=None, ragged=False,
          **kwargs):
  input_layer = InputLayer(shape, batch_size, name, dtype, sparse, tensor, ragged, **kwargs)
