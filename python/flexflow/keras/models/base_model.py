  ...
  def _create_flexflow_layers(self):
    ...
    for layer in self._layers:
      ...
      if isinstance(layer, Activation) == True:
        ...
        out_t = self._ffmodel.embedding(layer.input_tensors[0].ffhandle, layer.input_dim, layer.out_channels, ff.AggrMode.AGGR_MODE_SUM, layer.embeddings_initializer)
      else:
        assert 0, "unknow layer"
