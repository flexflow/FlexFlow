...
class LLM:
    ...
    def __init__(
        ...
        assert self.data_type == DataType.DT_HALF or self.data_type == DataType.DT_FLOAT or self.data_type == DataType.DT_BF16
    ...
    def download_hf_weights_if_needed(self):
        ...
        elif self.data_type == DataType.DT_BF16:
        ...
        self.weights_path = os.path.join(
            ...
            else "bfloat16-precision" if self.data_type == DataType.DT_BF16
            else "half-precision",
        )
