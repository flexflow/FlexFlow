...
class FFModel(object):
  ...
  def embedding(self, input, num_embeddings, embedding_dim, 
    ...
    if kernel_initializer is None:
      kernel_initializer = GlorotUniformInitializer(seed=42)
    ...
    handle = ffc.flexflow_model_add_embedding(self.handle, input.handle, num_embeddings, embedding_dim, c_aggr, shared_op_handle, kernel_initializer.handle, c_name)
