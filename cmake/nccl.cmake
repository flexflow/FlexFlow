...
if(NCCL_URL)
  ...
  ExternalProject_Add(${NCCL_NAME}
   ...
   INSTALL_COMMAND ""
   CONFIGURE_COMMAND ""
   BUILD_COMMAND make src.build "${NCCL_BUILD_NVCC_GENCODE} --disable-warnings" "CUDA_HOME=${CUDA_TOOLKIT_ROOT_DIR}" "BUILDDIR=${CMAKE_BINARY_DIR}/deps/nccl" "CXX=${CMAKE_CXX_COMPILER} -w" CC="${CMAKE_CC_COMPILER}"
   BUILD_IN_SOURCE 1
  )
