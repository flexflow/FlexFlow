...
if(NCCL_URL)
  ...
  ExternalProject_Add(${NCCL_NAME}
   ...
   INSTALL_COMMAND ""
   CONFIGURE_COMMAND ""
   BUILD_COMMAND make src.build "NVCUFLAGS=-w" "${NCCL_BUILD_NVCC_GENCODE}" "CUDA_HOME=${CUDA_TOOLKIT_ROOT_DIR}" "BUILDDIR=${CMAKE_BINARY_DIR}/deps/nccl" "CXX=${CMAKE_CXX_COMPILER}" CC="${CMAKE_CC_COMPILER}" "CXXFLAGS=-w"
   BUILD_IN_SOURCE 1
  )
