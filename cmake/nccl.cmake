...
if((FF_USE_PREBUILT_NCCL OR FF_USE_ALL_PREBUILT_LIBRARIES) AND CMAKE_HOST_SYSTEM_PROCESSOR MATCHES "x86_64")
  if(LINUX_VERSION MATCHES "20.04")
    if (CUDA_VERSION VERSION_EQUAL "11.0")
      set(NCCL_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/nccl_ubuntu-20.04_11.0.tar.gz")
    elseif(CUDA_VERSION VERSION_EQUAL "11.1")
      set(NCCL_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/nccl_ubuntu-20.04_11.1.tar.gz")
    elseif(CUDA_VERSION VERSION_EQUAL "11.2")
      set(NCCL_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/nccl_ubuntu-20.04_11.2.tar.gz")
    elseif(CUDA_VERSION VERSION_EQUAL "11.3")
      set(NCCL_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/nccl_ubuntu-20.04_11.3.tar.gz")
    elseif(CUDA_VERSION VERSION_EQUAL "11.4")
      set(NCCL_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/nccl_ubuntu-20.04_11.4.tar.gz")
    elseif(CUDA_VERSION VERSION_EQUAL "11.5")
      set(NCCL_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/nccl_ubuntu-20.04_11.5.tar.gz")
    elseif(CUDA_VERSION VERSION_EQUAL "11.6")
      set(NCCL_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/nccl_ubuntu-20.04_11.6.tar.gz")
  ...
  elseif(LINUX_VERSION MATCHES "18.04")
    if (CUDA_VERSION VERSION_EQUAL "10.1")
      set(NCCL_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/nccl_ubuntu-18.04_10.1.tar.gz")
    elseif (CUDA_VERSION VERSION_EQUAL "10.2")
      set(NCCL_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/nccl_ubuntu-18.04_10.2.tar.gz")
    elseif (CUDA_VERSION VERSION_EQUAL "11.0")
      set(NCCL_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/nccl_ubuntu-18.04_11.0.tar.gz")
    elseif(CUDA_VERSION VERSION_EQUAL "11.1")
      set(NCCL_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/nccl_ubuntu-18.04_11.1.tar.gz")
    elseif(CUDA_VERSION VERSION_EQUAL "11.2")
      set(NCCL_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/nccl_ubuntu-18.04_11.2.tar.gz")
    elseif(CUDA_VERSION VERSION_EQUAL "11.3")
      set(NCCL_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/nccl_ubuntu-18.04_11.3.tar.gz")
    elseif(CUDA_VERSION VERSION_EQUAL "11.4")
      set(NCCL_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/nccl_ubuntu-18.04_11.4.tar.gz")
    elseif(CUDA_VERSION VERSION_EQUAL "11.5")
      set(NCCL_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/nccl_ubuntu-18.04_11.5.tar.gz")
    elseif(CUDA_VERSION VERSION_EQUAL "11.6")
      set(NCCL_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/nccl_ubuntu-18.04_11.6.tar.gz")
    elseif(CUDA_VERSION VERSION_EQUAL "11.7")
      set(NCCL_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/nccl_ubuntu-18.04_11.7.tar.gz")
    endif()
  endif()
endif()
