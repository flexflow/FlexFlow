...
if (FF_GPU_BACKEND EQUAL "cuda")
  set(Legion_USE_CUDA ON CACHE BOOL "enable Legion_USE_CUDA")
  set(Legion_CUDA_ARCH ${FF_CUDA_ARCH} CACHE STRING "Legion CUDA ARCH")
elseif (FF_GPU_BACKEND EQUAL "hip_cuda")
  set(Legion_USE_HIP ON CACHE BOOL "enable Legion_USE_HIP")
  set(Legion_HIP_TARGET "CUDA" CACHE STRING "Legion HIP target CUDA")
elseif (FF_GPU_BACKEND EQUAL "hip_rocm")
  set(Legion_USE_HIP ON CACHE BOOL "enable Legion_USE_HIP")
  set(Legion_HIP_TARGET "ROCM" CACHE STRING "Legion HIP target CUDA")
else()
endif()
