if(FF_USE_EXTERNAL_LEGION)
	...
	if((FF_USE_PREBUILT_LEGION OR FF_USE_ALL_PREBUILT_LIBRARIES) AND CMAKE_HOST_SYSTEM_PROCESSOR MATCHES "x86_64" AND 
		...
		if(LINUX_VERSION MATCHES "20.04" OR LINUX_VERSION MATCHES "18.04")
			...
			if (PY_VERSION VERSION_GREATER_EQUAL "3.7" AND PY_VERSION VERSION_LESS_EQUAL "3.10")
				if (FF_GPU_BACKEND STREQUAL "cuda")
					set(LEGION_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/legion_ubuntu-${LINUX_VERSION}_cuda-${CUDA_VERSION}_python${PY_VERSION}.tar.gz")
				elseif (LINUX_VERSION MATCHES "20.04" AND FF_GPU_BACKEND STREQUAL "hip_rocm")
					set(LEGION_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/legion_ubuntu-20.04_hip_rocm_python${PY_VERSION}.tar.gz")
				endif()
			endif()
		endif()
	endif()
	...
	if(LEGION_URL)
		...
		set(LEGION_FOLDER_PATH ${${LEGION_NAME}_SOURCE_DIR})
