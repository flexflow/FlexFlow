			...
			if(LINUX_VERSION MATCHES "20.04")
				if (FF_GPU_BACKEND STREQUAL "cuda")
					if (CUDA_VERSION VERSION_EQUAL "11.0")
					  set(LEGION_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/legion_ubuntu-20.04_cuda_11.0.3.tar.gz")
					elseif(CUDA_VERSION VERSION_EQUAL "11.1")
					  set(LEGION_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/legion_ubuntu-20.04_cuda_11.1.1.tar.gz")
					elseif(CUDA_VERSION VERSION_EQUAL "11.2")
					  set(LEGION_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/legion_ubuntu-20.04_cuda_11.2.2.tar.gz")
					elseif(CUDA_VERSION VERSION_EQUAL "11.3")
					  set(LEGION_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/legion_ubuntu-20.04_cuda_11.3.1.tar.gz")
					elseif(CUDA_VERSION VERSION_EQUAL "11.4")
					  set(LEGION_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/legion_ubuntu-20.04_cuda_11.4.3.tar.gz")
					elseif(CUDA_VERSION VERSION_EQUAL "11.5")
					  set(LEGION_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/legion_ubuntu-20.04_cuda_11.5.2.tar.gz")
					elseif(CUDA_VERSION VERSION_EQUAL "11.6")
					  set(LEGION_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/legion_ubuntu-20.04_cuda_11.6.2.tar.gz")
					elseif(CUDA_VERSION VERSION_EQUAL "11.7")
					  set(LEGION_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/legion_ubuntu-20.04_cuda_11.7.0.tar.gz")
					endif()
				elseif(FF_GPU_BACKEND STREQUAL "hip_rocm" AND CUDA_VERSION VERSION_EQUAL "11.1")
					set(LEGION_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/legion_ubuntu-20.04_hip_rocm_11.1.1.tar.gz")
				endif()
			  elseif(LINUX_VERSION MATCHES "18.04")
				if (CUDA_VERSION VERSION_EQUAL "10.1")
				  set(LEGION_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/legion_ubuntu-18.04_cuda_10.1.243.tar.gz")
				elseif (CUDA_VERSION VERSION_EQUAL "10.2")
				  set(LEGION_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/legion_ubuntu-18.04_cuda_10.2.89.tar.gz")
				elseif (CUDA_VERSION VERSION_EQUAL "11.0")
				  set(LEGION_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/legion_ubuntu-18.04_cuda_11.0.3.tar.gz")
				elseif(CUDA_VERSION VERSION_EQUAL "11.1")
				  set(LEGION_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/legion_ubuntu-18.04_cuda_11.1.1.tar.gz")
				elseif(CUDA_VERSION VERSION_EQUAL "11.2")
				  set(LEGION_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/legion_ubuntu-18.04_cuda_11.2.2.tar.gz")
				elseif(CUDA_VERSION VERSION_EQUAL "11.3")
				  set(LEGION_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/legion_ubuntu-18.04_cuda_11.3.1.tar.gz")
				elseif(CUDA_VERSION VERSION_EQUAL "11.4")
				  set(LEGION_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/legion_ubuntu-18.04_cuda_11.4.3.tar.gz")
				elseif(CUDA_VERSION VERSION_EQUAL "11.5")
				  set(LEGION_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/legion_ubuntu-18.04_cuda_11.5.2.tar.gz")
				elseif(CUDA_VERSION VERSION_EQUAL "11.6")
				  set(LEGION_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/legion_ubuntu-18.04_cuda_11.6.2.tar.gz")
				elseif(CUDA_VERSION VERSION_EQUAL "11.7")
				  set(LEGION_URL "https://github.com/flexflow/flexflow-third-party/releases/latest/download/legion_ubuntu-18.04_cuda_11.7.0.tar.gz")
				endif()
			  endif()
		endif()
	endif()
