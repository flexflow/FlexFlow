...
ComputationGraph
  ...
  auto create_attention_encoder =
    ...
    tensor_guid_t t = cgb.multihead_attention(query,
                                              key,
                                              value,
                                              ...
                                              kdim,
                                              vdim);
    tensor_guid_t normalized_t = cgb.layer_norm(cgb.add(t, query),
                                                layer_norm_axis,
  ...
  t = cgb.softmax(cgb.dense(
      t, tfConfig.vocab_size /* outDim */, Activation::RELU, true /* bias */));
