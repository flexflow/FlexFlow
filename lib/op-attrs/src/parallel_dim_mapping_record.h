...
public:
  ...
  input_output_record(int input_idx, int input_dim, int output_idx,
                      int output_dim,
                      tl::optional<MappingOperation> operation = tl::nullopt);
  static ParallelDimMappingRecord
  input_weight_record(int input_idx, int input_dim, int weight_idx,
                      int weight_dim,
                      tl::optional<MappingOperation> operation = tl::nullopt);
...
VISITABLE_STRUCT(::FlexFlow::ParallelDimMappingRecord, type, operation,
                 output_dim, input_dim, weight_dim, output_idx, input_idx,
                 weight_idx);
