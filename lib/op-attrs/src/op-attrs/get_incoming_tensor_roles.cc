...
std::vector<IncomingTensorRole>
    get_incoming_tensor_roles(ComputationGraphOpAttrs const &comp_graph_op_attrs, int num_incoming) {
  return get_incoming_tensor_roles(pcg_op_attrs_from_compgraph_op_attrs(comp_graph_op_attrs), num_incoming);
}

std::vector<IncomingTensorRole>
    get_incoming_tensor_roles(PCGOperatorAttrs const &pcg_op_attrs, int num_incoming) {
  return pcg_op_attrs.visit<
    std::vector<IncomingTensorRole>
  >(overload {
    [](BatchMatmulAttrs const &) { 
      return std::vector{IncomingTensorRole::INPUT, IncomingTensorRole::INPUT};
    },
    ...
    [](EmbeddingAttrs const &) { 
      return std::vector{IncomingTensorRole::INPUT, IncomingTensorRole::WEIGHT};
    },
    [](FlatAttrs const &) { 
      return std::vector{IncomingTensorRole::INPUT};
    },
    ...
    [](InputAttrs const &) { 
      return std::vector<IncomingTensorRole>{};
    },
