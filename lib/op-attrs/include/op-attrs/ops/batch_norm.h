...
tl::expected<TensorShape, std::string>
  get_output_shape(BatchNormAttrs const &, TensorShape const &);
tl::expected<TensorShape, std::string>
...
tl::expected<ParallelTensorDimDegrees, std::string>
  get_output_parallel_dim_degrees(BatchNormAttrs const &, ParallelTensorDimDegrees const &);
tl::expected<ParallelTensorDimDegrees, std::string>
  get_gamma_weights_parallel_dim_degrees(BatchNormAttrs const &, ParallelTensorDimDegrees const &);
tl::expected<ParallelTensorDimDegrees, std::string>
  get_beta_weights_parallel_dim_degrees(BatchNormAttrs const &, ParallelTensorDimDegrees const &);


tl::expected<ParallelTensorShape, std::string>
  get_output_shape(BatchNormAttrs const &,
                   ParallelTensorShape const &);
tl::expected<ParallelTensorShape, std::string>
  get_gamma_weights_shape(BatchNormAttrs const &, ParallelTensorShape const &);
tl::expected<ParallelTensorShape, std::string>
