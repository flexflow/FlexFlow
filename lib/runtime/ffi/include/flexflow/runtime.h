...
flexflow_runtime_error_code_t flexflow_runtime_error_get_error_code(flexflow_runtime_error_t, flexflow_runtime_error_code_t *out);
...
flexflow_error_t flexflow_model_config_parse_argv(
...
flexflow_error_t flexflow_set_tensor_int(
