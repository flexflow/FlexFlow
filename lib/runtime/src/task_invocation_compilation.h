...
TaskArgumentsFormat create_serializable_format(ConcreteArgsFormat const &,
                                               FutureArgsFormat const &,
                                               optional<TensorArgsFormat> const & = nullopt,
                                               optional<IndexArgsFormat> const & = nullopt);

Legion::TaskArgument as_task_argument(ConcreteArgsFormat const &,
                                      FutureArgsFormat const &,
                                      optional<TensorArgsFormat> const & = nullopt,
                                      optional<IndexArgsFormat> const & = nullopt);
...
Legion::Future execute_task(Legion::TaskLauncher const &, RuntimeBacking const &);
Legion::FutureMap execute_task(Legion::IndexTaskLauncher const &, RuntimeBacking const &);
