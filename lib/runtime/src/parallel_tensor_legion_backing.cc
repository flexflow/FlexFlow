...
ParallelTensorLegionBacking::ParallelTensorLegionBacking(IndexSpace const &_parallel_is,
  ...
  : parallel_is(_parallel_is),
    region(_region),
    region_grad(_region_grad),
    part(_part),
    part_grad(_part_grad),
    physical_region(_physical_region)
{ }
