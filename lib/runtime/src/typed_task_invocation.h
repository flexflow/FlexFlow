...
template <typename T>
TypedIndexTaskInvocation<T> ensure_index_return_type(TaskInvocation const &);
...
struct TypedIndexTaskInvocation {
  ...
  friend TypedIndexTaskInvocation
      ensure_index_return_type<T>(TaskInvocation const &);
...
TypedIndexTaskInvocation<T>
    ensure_index_return_type(TaskInvocation const &invocation);
