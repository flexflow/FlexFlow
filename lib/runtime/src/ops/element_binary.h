...
template <> void register_task<ELEMENTBINARY_INIT_TASK_ID>();
template <> void register_task<ELEMENTBINARY_FWD_TASK_ID>();
template <> void register_task<ELEMENTBINARY_BWD_TASK_ID>();
