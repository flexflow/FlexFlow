...
/*   /1* opmeta::OperatorParameters find_bottleneck_node(opmeta::OperatorParameters const &sink_node, *1/ */
/*   /1*                           opmeta::OperatorParameters const &source_node) const; *1/ */
...
/*   /1*     split_at_node(opmeta::OperatorParameters const &bottleneck) const; *1/ */
/*   /1* std::pair<std::unique_ptr<Graph>, std::unique_ptr<Graph>> *1/ */
/*   /1*     split_horizontal(opmeta::OperatorParameters const &source_node, opmeta::OperatorParameters const &sink_node) const; *1/ */
...
/* /1*   void set_src(G const &g, edge_type &e, vertex_type const &n) const { *1/ */
/* /1*     e.srcOp = n; *1/ */
/* /1*   } *1/ */

/* /1*   void set_dst(G const &g, edge_type &e, vertex_type const &n) const { *1/ */
/* /1*     e.dstOp = n; *1/ */
/* /1*   } *1/ */
/* /1* }; *1/ */
