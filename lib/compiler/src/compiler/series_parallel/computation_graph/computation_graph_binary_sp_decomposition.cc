...
GenericBinarySPDecompositionTreeImplementation<
  ...
  return GenericBinarySPDecompositionTreeImplementation<
    ...
    ComputationGraphBinaryParallelSplit,
    layer_guid_t>{
    /*series_get_left_child=*/[](ComputationGraphBinarySeriesSplit const &split) -> ComputationGraphBinarySPDecomposition const & {
      return split.get_left_child(); 
    },
    /*parallel_get_left_child=*/[](ComputationGraphBinaryParallelSplit const &split) -> ComputationGraphBinarySPDecomposition const & {
      return split.get_left_child();
    },
    /*series_get_right_child=*/[](ComputationGraphBinarySeriesSplit const &split) -> ComputationGraphBinarySPDecomposition const & {
      return split.get_right_child();
    },
    /*parallel_get_right_child=*/[](ComputationGraphBinaryParallelSplit const &split) -> ComputationGraphBinarySPDecomposition const & {
      return split.get_right_child();
    },
    /*get_node_type=*/[](ComputationGraphBinarySPDecomposition const &tree) -> SPDecompositionTreeNodeType {
      return get_node_type(tree);
    },
    /*require_series=*/[](ComputationGraphBinarySPDecomposition const &tree) -> ComputationGraphBinarySeriesSplit const & {
      return tree.get<ComputationGraphBinarySeriesSplit>();
    },
    /*require_parallel=*/[](ComputationGraphBinarySPDecomposition const &tree) -> ComputationGraphBinaryParallelSplit const & {
      return tree.get<ComputationGraphBinaryParallelSplit>();
    },
    /*require_leaf=*/[](ComputationGraphBinarySPDecomposition const &tree) -> layer_guid_t const & {
...
ComputationGraphBinarySPDecomposition 
  computation_graph_sp_decomp_from_binary_sp_decomp(BinarySPDecompositionTree const &bin) {
  return bin.visit<ComputationGraphBinarySPDecomposition>(overload {
    [](BinarySeriesSplit const &series) {
      return ComputationGraphBinarySPDecomposition{
        ComputationGraphBinarySeriesSplit{
          computation_graph_sp_decomp_from_binary_sp_decomp(series.get_left_child()),
          computation_graph_sp_decomp_from_binary_sp_decomp(series.get_right_child()),
        },
      };
    },
    [](BinaryParallelSplit const &parallel) {
      return ComputationGraphBinarySPDecomposition{
        ComputationGraphBinaryParallelSplit{
          computation_graph_sp_decomp_from_binary_sp_decomp(parallel.get_left_child()),
          computation_graph_sp_decomp_from_binary_sp_decomp(parallel.get_right_child()),
        },
      };
    },
    [](Node const &node) {
