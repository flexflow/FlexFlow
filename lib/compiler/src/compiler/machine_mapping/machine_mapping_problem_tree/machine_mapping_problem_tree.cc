...
MachineMappingProblemTree
  ...
  return MachineMappingProblemTree{
      make_generic_binary_parallel_split(
          MMProblemTreeParallelSplitLabel{}, lhs.raw_tree, rhs.raw_tree),
  };
}

MachineMappingProblemTree
    mm_problem_tree_make_leaf(UnmappedOpCostEstimateKey const &leaf_label) {
  return MachineMappingProblemTree{
      make_generic_binary_sp_leaf<MMProblemTreeSeriesSplitLabel,
...
MMProblemTreeSeriesSplit
    require_series_split(MachineMappingProblemTree const &t) {
...
MMProblemTreeParallelSplit
    require_parallel_split(MachineMappingProblemTree const &t) {
...
MachineMappingProblemTree
    wrap_series_split(MMProblemTreeSeriesSplit const &series) {
  return MachineMappingProblemTree{
...
MachineMappingProblemTree
    wrap_parallel_split(MMProblemTreeParallelSplit const &parallel) {
  return MachineMappingProblemTree{
...
std::unordered_multiset<UnmappedOpCostEstimateKey>
    get_leaves(MachineMappingProblemTree const &t) {
  return get_leaves(t.raw_tree);
}

std::unordered_set<BinaryTreePath>
    get_all_leaf_paths(MachineMappingProblemTree const &t) {
...
std::optional<MachineMappingProblemTree>
  ...
  std::optional<
      GenericBinarySPDecompositionTree<MMProblemTreeSeriesSplitLabel,
                                       MMProblemTreeParallelSplitLabel,
