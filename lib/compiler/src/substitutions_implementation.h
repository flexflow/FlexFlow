...
substitutions::SubstitutionPattern
create_replicate_linear_combine(int num_dims, int num_parts,
                                ActiMode activation, bool use_bias);
substitutions::SubstitutionPattern
create_partition_linear_combine(int num_dims, int num_parts,
                                ActiMode activation, bool use_bias);
substitutions::SubstitutionPattern
...
substitutions::SubstitutionPattern
create_partition_concat_combine(int num_inputs, int concat_dim,
                                int parallel_dim, int num_parts);
substitutions::SubstitutionPattern
create_partition_softmax_combine(int softmax_dim, int part_dim, int num_parts);
substitutions::SubstitutionPattern
leading_relu_branch_combine(int parallel_dim, int num_parts, int num_combines);
substitutions::SubstitutionPattern
leading_relu_branch_partition(int parallel_dim, int num_parts,
                              int num_partitions);
