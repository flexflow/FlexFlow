...
tl::optional<V> evaluate_list_index_access(ListIndexAccess<T> const &index_access, tl::optional<V> const &v) {
  if (!v.has_value() || !mpark::holds_alternative<std::vector<int>>(v.value())) {
    return tl::nullopt;
  }
...
struct EvaluateOperatorAttributeExpr {
  ...
  tl::optional<OperatorAttributeValue> operator()(ListIndexAccess<OperatorAttributeKey> const &index_access) {
    tl::optional<OperatorAttributeValue> v = get_attribute(this->attrs, index_access.attribute_key);
    return evaluate_list_index_access(index_access, v);
  }

  tl::optional<OperatorAttributeValue> operator()(ListSize<OperatorAttributeKey> const &list_size) {
    tl::optional<OperatorAttributeValue> v = get_attribute(this->attrs, list_size.attribute_key);
...
struct EvaluateTensorAttributeExpr {
  EvaluateTensorAttributeExpr(ParallelTensorShape const &tensor_shape) : tensor_shape(tensor_shape) { }
  ...
  tl::optional<TensorAttributeValue> operator()(ListIndexAccess<TensorAttributeKey> const &index_access) {
    auto v = this->evaluate(index_access.attribute_key);
    return evaluate_list_index_access(index_access, v);
  }

  tl::optional<TensorAttributeValue> operator()(ListSize<TensorAttributeKey> const &list_size) {
...
tl::optional<TensorAttributeValue> evaluate_attribute_expr(ParallelTensorShape const &tensor_shape, AttributeExpr<TensorAttributeKey> const &expr) {
...
template <typename V>
tl::optional<bool> satisfies(ConstraintType constraint_type, V const &constraint_value, tl::optional<V> const &maybe_attribute_value) {
  /* tl::optional<V> maybe_attr_val = evalute_attribute_expr(attrs, constraint.attribute_expr); */
...
tl::optional<bool> satisfies(ParallelTensorShape const &tensor_shape, TensorAttributeConstraint const &constraint) {
...
tl::optional<bool> optional_all_of(Container const &container, Function const &func) {
...
tl::optional<bool> satisfies(ParallelTensorShape const &params, ParallelTensorPattern const &pattern) {
