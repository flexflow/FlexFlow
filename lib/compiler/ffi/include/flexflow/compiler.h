...
flexflow_error_t flexflow_computation_graph_compile(
    flexflow_computation_graph_t, flexflow_machine_specification_t,
    flexflow_search_algorithm_config_t, flexflow_search_result_t *out);
...
flexflow_error_t flexflow_search_result_get_parallel_tensor_for_tensor(
    flexflow_search_result_t, flexflow_tensor_t,
