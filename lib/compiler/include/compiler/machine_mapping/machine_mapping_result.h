...
[[nodiscard]] MachineMappingResult parallel_combine(MachineMappingResult const &lhs_result,
...
[[nodiscard]] MachineMappingResult make_singleton_machine_mapping_result(float runtime,
