...
MachineMappingConstraints restrict_to_child(MachineMappingConstraints const &,
                                            BinaryTreePathEntry const &);
MachineMappingConstraints
    restrict_to_left_child(MachineMappingConstraints const &);
MachineMappingConstraints
    restrict_to_right_child(MachineMappingConstraints const &);
