...
MachineView make_1d_machine_view(device_id_t start, device_id_t stop, int stride) {
...
static StridedRectangle make_1d_rect(int start, num_points_t num_points, int stride) {
...
static StridedRectangle make_1d_rect(int start, side_size_t interval_size, int stride) {
