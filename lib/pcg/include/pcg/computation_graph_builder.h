...
struct ComputationGraphBuilder : public use_visitable_cmp<ComputationGraphBuilder> {
public:
  ...
  // Add a concat layer
  Tensor
      concat(int n, std::vector<Tensor> const &tensors, int axis, optional<std::string> const &name = nullopt);
  // Add a mean layer
