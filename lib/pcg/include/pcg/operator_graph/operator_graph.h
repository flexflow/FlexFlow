...
public:
  ...
  std::unordered_set<OperatorGraphOutput>
      query_outputs(OperatorGraphOutputQuery const &) const;
  std::unordered_set<OperatorGraphEdge>
      query_edges(OperatorGraphEdgeQuery const &) const;
...
std::vector<OperatorGraphOutput> get_outputs(OperatorGraphView const &,
                                             Node const &);
...
public:
  ...
  Node add_node(std::vector<OperatorGraphOutput> const &inputs,
                int num_outputs);
...
template <typename NodeLabel, typename OutputLabel>
struct LabelledOperatorGraph
    : virtual LabelledOperatorGraphView<NodeLabel, OutputLabel> {
  Node add_node(NodeLabel const &,
                std::vector<OperatorGraphOutput> const &inputs,
