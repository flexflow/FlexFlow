...
V1MultiDiGraph to_v1(MultiDiGraphView const &, std::unordered_map<Node, size_t> const &, std::unordered_map<NodePort, size_t> const &);
...
FF_VISITABLE_STRUCT(V1ComputationGraph, node_labels, outputs, output_labels, graph);
...
FF_VISITABLE_STRUCT(V1ParallelComputationGraph, node_labels, outputs, output_labels, graph);
