...
struct prepend<Element, std::tuple<Args...>>
    : type_identity<std::tuple<Element, Args...>> {};

template <typename Element, typename... Args>
struct prepend<Element, std::variant<Args...>>
    : type_identity<std::variant<Element, Args...>> {};
