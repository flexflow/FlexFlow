...
struct is_isomorphic_to_pair : std::false_type {};
template <typename T>
struct is_isomorphic_to_pair<T, std::enable_if_t<is_pair_v<T>>>
    : std::true_type {};
template <typename T1, typename T2>
struct is_isomorphic_to_pair<std::pair<T1, T2>> : std::true_type {};
template <typename T1, typename T2>
struct is_isomorphic_to_pair<std::tuple<T1, T2>> : std::true_type {};
template <typename T>
struct is_isomorphic_to_pair<std::array<T, 2>> : std::true_type {};
