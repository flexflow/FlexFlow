...
TEST_SUITE(FF_TEST_SUITE) {
  TEST_CASE("get_outgoing_edges") {
    ...
    std::unordered_map<Node, std::unordered_set<DirectedEdge>> correct = {
      ...
      {n.at(1), {DirectedEdge{n.at(1), n.at(2)}, DirectedEdge{n.at(1), n.at(3)}, DirectedEdge{n.at(1), n.at(5)}}},
    ...
    std::unordered_map<Node, std::unordered_set<DirectedEdge>> result = get_outgoing_edges(g, get_nodes(g));
