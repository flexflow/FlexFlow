...
TEST_SUITE(FF_TEST_SUITE) {
  TEST_CASE("get_dominators_map") {
    ...
    std::unordered_map<Node, std::unordered_set<Node>> correct = {
      {n.at(0), {n.at(0)}},
      {n.at(1), {n.at(0), n.at(1)}},
      {n.at(2), {n.at(0), n.at(1), n.at(2)}},
      {n.at(3), {n.at(0), n.at(1), n.at(3)}},
      {n.at(4), {n.at(0), n.at(1), n.at(4)}},
      {n.at(5), {n.at(0), n.at(1), n.at(5)}},
    };

    std::unordered_map<Node, std::unordered_set<Node>> result = get_dominators_map(g);
