...
TEST_SUITE(FF_TEST_SUITE) {
  TEST_CASE("right_associative_binary_sp_tree_from_nary(SerialParallelDecomposition)") {
    Node n1 = Node{1};
    Node n2 = Node{2};
    Node n3 = Node{3};
    ...
    SUBCASE("only serial") {
      ...
      BinarySPDecompositionTree result = right_associative_binary_sp_tree_from_nary(input);
