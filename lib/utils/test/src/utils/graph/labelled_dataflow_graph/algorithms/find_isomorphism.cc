...
TEST_SUITE(FF_TEST_SUITE) {
  TEST_CASE("find_isomorphism(LabelledDataflowGraphView, LabelledDataflowGraphView)") {
    ...
    SUBCASE("duplicate labels") {
      ...
      std::optional<DataflowGraphIsomorphism> correct =
          DataflowGraphIsomorphism{
              bidict<Node, Node>{
                  {g1_n1_node, g2_n1_node},
                  {g1_n2_node, g2_n2_node},
                  {g1_n3_node, g2_n3_node},
              },
          };

      std::optional<DataflowGraphIsomorphism> result =
    ...
    SUBCASE("non-duplicate labels") {
      ...
      SUBCASE("input graphs are not isomorphic (mismatched node labels)") {
        ...
        std::optional<DataflowGraphIsomorphism> correct = std::nullopt;
