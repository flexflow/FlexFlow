...
TEST_SUITE(FF_TEST_SUITE) {
  TEST_CASE("get_unused_open_dataflow_graph_inputs(OpenDataflowGraphView)") {
    ...
    SUBCASE("unused inputs exist") {
      ...
      std::unordered_set<DataflowGraphInput> result = get_unused_open_dataflow_graph_inputs(g);
    ...
    SUBCASE("unused inputs don't exist") {
      ...
      NodeAddedResult g_n1_added = g.add_node({OpenDataflowValue{g_i1}, OpenDataflowValue{g_i2}}, 1);
