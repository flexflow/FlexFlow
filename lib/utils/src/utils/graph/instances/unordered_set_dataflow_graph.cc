...
NodeAddedResult UnorderedSetDataflowGraph::add_node(std::vector<DataflowOutput> const &inputs,
                                                    int num_outputs) {
  std::vector<OpenDataflowValue> open_inputs = transform(inputs, [](DataflowOutput const &o) { return OpenDataflowValue{o}; });
  return this->add_node(open_inputs, num_outputs);
}

NodeAddedResult UnorderedSetDataflowGraph::add_node(std::vector<OpenDataflowValue> const &inputs,
                                                    int num_outputs) {
...
DataflowGraphInput UnorderedSetDataflowGraph::add_input() {
  DataflowGraphInput new_graph_input = this->graph_input_source.new_dataflow_graph_input(); 
...
std::unordered_set<OpenDataflowEdge> UnorderedSetDataflowGraph::query_edges(OpenDataflowEdgeQuery const &q) const {
...
std::unordered_set<DataflowGraphInput> UnorderedSetDataflowGraph::get_inputs() const {
