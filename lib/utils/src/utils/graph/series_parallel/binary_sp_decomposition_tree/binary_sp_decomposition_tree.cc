...
GenericBinarySPDecompositionTreeImplementation<
  ...
  return GenericBinarySPDecompositionTreeImplementation<
    ...
    Node>
  {
    /*series_get_left_child=*/[](BinarySeriesSplit const &split) -> BinarySPDecompositionTree const & {
      return split.get_left_child();
    },
    /*parallel_get_left_child=*/[](BinaryParallelSplit const &split) -> BinarySPDecompositionTree const & {
      return split.get_left_child();
    },
    /*series_get_right_child=*/[](BinarySeriesSplit const &split) -> BinarySPDecompositionTree const & {
      return split.get_right_child();
    },
    /*parallel_get_right_child=*/[](BinaryParallelSplit const &split) -> BinarySPDecompositionTree const & {
      return split.get_right_child();
    },
    /*get_node_type=*/[](BinarySPDecompositionTree const &tree) -> SPDecompositionTreeNodeType {
      return get_node_type(tree);
    },
    /*require_series=*/[](BinarySPDecompositionTree const &tree) -> BinarySeriesSplit const & {
      return tree.require_series();
    },
    /*require_parallel=*/[](BinarySPDecompositionTree const &tree) -> BinaryParallelSplit const & {
      return tree.require_parallel();
    },
    /*require_leaf=*/[](BinarySPDecompositionTree const &tree) -> Node const & {
...
SPDecompositionTreeNodeType get_node_type(BinarySPDecompositionTree const &tree) {
