...
bool open_dataflow_edge_query_includes(OpenDataflowEdgeQuery const &q, OpenDataflowEdge const &open_e) {
  return open_e.visit<bool>(overload {
    [&](DataflowEdge const &e) { return dataflow_edge_query_includes_dataflow_edge(q.standard_edge_query, e); },
    [&](DataflowInputEdge const &e) { return dataflow_input_edge_query_includes(q.input_edge_query, e); },
  });
}
