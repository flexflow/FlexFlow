...
template std::ostream &operator<<(std::ostream &, FullBinaryTreeParentNode<int, int> const &);
template std::ostream &operator<<(std::ostream &, FullBinaryTree<int, int> const &);
