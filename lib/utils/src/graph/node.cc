...
ptr, and define a empty lambda function to delete the ptr 2 we use this ptr to
create a GraphView, this GraphView is read-only. It creates a GraphView object
