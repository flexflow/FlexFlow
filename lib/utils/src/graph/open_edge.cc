...
OpenMultiDiEdgeQuery::OpenMultiDiEdgeQuery(
    InputMultiDiEdgeQuery const &input_edge_query,
...
DownwardOpenMultiDiEdgeQuery::operator OpenMultiDiEdgeQuery() const {
  return OpenMultiDiEdgeQuery(
      InputMultiDiEdgeQuery::none(), standard_edge_query, output_edge_query);
}
...
UpwardOpenMultiDiEdgeQuery::UpwardOpenMultiDiEdgeQuery(
    InputMultiDiEdgeQuery const &input_edge_query)
    : input_edge_query(input_edge_query),
      standard_edge_query(MultiDiEdgeQuery::none()) {}
UpwardOpenMultiDiEdgeQuery::UpwardOpenMultiDiEdgeQuery(
    MultiDiEdgeQuery const &standard_edge_query)
    : input_edge_query(InputMultiDiEdgeQuery::none()),
      standard_edge_query(standard_edge_query) {}
