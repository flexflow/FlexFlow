...
OpenMultiDiEdgeQuery::OpenMultiDiEdgeQuery(InputMultiDiEdgeQuery const &input_edge_query,
                      ...
                      OutputMultiDiEdgeQuery const &output_edge_query) : input_edge_query(input_edge_query), standard_edge_query(standard_edge_query), output_edge_query(output_edge_query) {}
