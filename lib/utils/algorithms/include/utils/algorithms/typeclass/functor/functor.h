...
/* template <typename T, typename Instance, typename InputType = other_functor_opaque_t, typename OutputType = functor_opaque_t> */
/* struct is_valid_functor_instance2 */
/*   : std::is_same< */
/*       std::invoke_result_t<decltype(Instance::template fmap<InputType>), T<InputType> const &, std::function<OutputType(InputType const &)>>, */ 
/*       T<OutputType> */
/*     > { }; */
