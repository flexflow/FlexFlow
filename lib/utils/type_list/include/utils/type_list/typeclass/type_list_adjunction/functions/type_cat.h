...
template <typename T1,
          typename T2,
          typename Instance = default_type_list_adjunction_t<T1>,
...
struct type_cat<T1,
                T2,
                Instance,
                std::enable_if_t<is_valid_type_list_adjunction_v<T, Instance> &&
                                 is_valid_type_list_adjunction_v<T, Instance>>>
    : from_type_list<Instance,
                     type_list_concat_t<to_type_list_t<T1, Instance>,
                                        to_type_list_t<T2, Instance>>> {};
