...
#define _DISPATCH_FUNC_NAME(MACRO, ...) \
  BOOST_PP_EXPAND(BOOST_PP_CAT(_DISPATCH_MAYBE_EMPTY_CASE, BOOST_PP_MIN(BOOST_PP_VARIADIC_SIZE(__ARGS__), 1)))

#define _DISPATCH_VISITABLE(MACRO, TYPENAME, ...) \
  BOOST_PP_EXPAND(_DISPATCH_FUNC_NAME(MACRO, __VA_ARGS__)(TYPENAME, __VA_ARGS__))
