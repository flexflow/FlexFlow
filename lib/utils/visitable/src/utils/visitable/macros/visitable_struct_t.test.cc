...
TEST_CASE("VISITABLE_STRUCT_T<>") {
  ...
  CHECK_TYPE_EQ(WRAP_ARG(visit_as_tuple_t<example_t_0>),
...
TEST_CASE("VISITABLE_STRUCT_T<T0, T1, T2, T3, T4, T5, T6>") {
  ...
  CHECK_SAME_TYPE(visit_as_tuple_t<T>,
                  std::tuple<opaque_type_0,
                             opaque_type_1,
                             opaque_type_2,
                             opaque_type_3,
                             opaque_type_4,
...
TEST_CASE("VISITALE_STRUCT_T<T0, T1, T2=T0, T3=T1>") {
  ...
  CHECK_SAME_TYPE(
      visit_as_tuple_t<T>,
      std::tuple<opaque_type_0, opaque_type_1, opaque_type_0, opaque_type_1>);
