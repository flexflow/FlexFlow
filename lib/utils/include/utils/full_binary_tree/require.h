...
FullBinaryTreeParentNode<ParentLabel, LeafLabel> const &require_parent_node(FullBinaryTree<ParentLabel, LeafLabel> const &t) {
  return std::get<FullBinaryTreeParentNode<ParentLabel, LeafLabel>>(t.root);
}

template <typename ParentLabel, typename LeafLabel>
LeafLabel const &require_leaf(FullBinaryTree<ParentLabel, LeafLabel> const &t) {
