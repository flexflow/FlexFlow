...
FullBinaryTreeParentNode<ParentLabel2, LeafLabel2>
    transform(FullBinaryTreeParentNode<ParentLabel, LeafLabel> const &t, F f) {
...
template <typename ParentLabel,
          ...
          typename ParentLabel2 = std::invoke_result_t<F, ParentLabel>,
          typename LeafLabel2 = std::invoke_result_t<F, LeafLabel>>
FullBinaryTree<ParentLabel2, LeafLabel2>
    transform(FullBinaryTree<ParentLabel, LeafLabel> const &t, F f) {
