...
std::optional<FullBinaryTree<ParentLabel, LeafLabel>>
    get_subtree_at_path(FullBinaryTree<ParentLabel, LeafLabel> const &t,
  ...
  return visit<std::optional<FullBinaryTree<ParentLabel, LeafLabel>>>(
      ...
      overload{
          ...
          [&](LeafLabel const &leaf) { return std::nullopt; }});
}
