...
template <capability NEEDLE, capability... HAYSTACK> struct has_capability;

template <capability NEEDLE, capability HEAD, capability ...HAYSTACK>
struct has_capability<NEEDLE, HEAD, HAYSTACK...> : disjunction<
                                    capability_implies<HEAD, NEEDLE>,
...
struct test_type_t {
  ...
  template<typename std::enable_if<supports<DEFAULT_CONSTRUCTIBLE>::value, bool>::type = true>
  test_type_t();

  template<typename std::enable_if<!supports<DEFAULT_CONSTRUCTIBLE>::value, bool>::type = true>
  test_type_t() = delete;

  template<typename std::enable_if<supports<COPYABLE>::value, bool>::type = true>
...
template <::FlexFlow::test_types::capability ...CAPABILITIES> //, typename = typename std::enable_if<::FlexFlow::test_types::has_capability<::FlexFlow::test_types::HASHABLE>::value, bool>::type>
struct hash<::FlexFlow::test_types::test_type_t<CAPABILITIES...>> {
  typename std::enable_if<
    ::FlexFlow::test_types::has_capability<::FlexFlow::test_types::HASHABLE, CAPABILITIES...>::value,
    size_t
  >::type
  operator()(::FlexFlow::test_types::test_type_t<CAPABILITIES...> const &) const;
};
