...
struct variant_join_helper<variant<Head, Args1...>, variant<Args2...>, 
  typename std::enable_if<!is_in_variant<Head, variant<Args2...>>::value>::type> {
  using type = typename variant_join_helper<variant<Args1...>, variant<Head, Args2...>>::type;
};

template <typename Head, typename ...Args1, typename ...Args2>
struct variant_join_helper<variant<Head, Args1...>, variant<Args2...>,
  typename std::enable_if<is_in_variant<Head, variant<Args2...>>::value>::type> {
  using type = typename variant_join_helper<variant<Args1...>, variant<Args2...>>::type;
};
