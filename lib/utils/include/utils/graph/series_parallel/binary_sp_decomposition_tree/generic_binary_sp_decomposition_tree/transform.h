...
GenericBinarySPDecompositionTree<SeriesLabel2, ParallelLabel2, LeafLabel2>
    transform(
        GenericBinarySPDecompositionTree<SeriesLabel,
                                         ParallelLabel,
                                         LeafLabel> const &tt,
        GenericBinarySPDecompositionTreeVisitor<SeriesLabel,
                                                ParallelLabel,
                                                LeafLabel,
                                                SeriesLabel2,
                                                ParallelLabel2,
...
GenericBinarySPDecompositionTree<SeriesLabel2, ParallelLabel2, LeafLabel2>
    transform(
        ...
        GenericBinarySPDecompositionTreeVisitor<SeriesLabel,
                                                ...
                                                ParallelLabel2,
                                                LeafLabel2> const &visitor) {
  return visit<GenericBinarySPDecompositionTree<SeriesLabel2,
                                                ParallelLabel2,
                                                LeafLabel2>>(
      tt,
      overload{
          ...
          [&](LeafLabel const &t) {
            return make_generic_binary_sp_leaf<SeriesLabel2, ParallelLabel2>(
                visitor.leaf_func(t));
          },
      });
}
