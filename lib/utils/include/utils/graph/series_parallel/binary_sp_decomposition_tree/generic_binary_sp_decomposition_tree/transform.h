...
// #include "utils/graph/series_parallel/binary_sp_decomposition_tree/generic_binary_sp_decomposition_tree/generic_binary_sp_decomposition_tree_transform_visitor.dtg.h"
...
//                                          ParallelLabel,
//                                          LeafLabel> const &tt,
//         GenericBinarySPDecompositionTreeTransformVisitor<SeriesLabel,
//                                                 ParallelLabel,
//                                                 LeafLabel,
//                                                 SeriesLabel2,
//                                                 ParallelLabel2,
//                                                 LeafLabel2> const &visitor);
//
// template <typename SeriesLabel,
//           typename ParallelLabel,
//           typename LeafLabel,
...
//           typename ParallelLabel2,
//           typename LeafLabel2>
// GenericBinarySeriesSplit<SeriesLabel2, ParallelLabel2, LeafLabel2> transform(
...
//           typename ParallelLabel2,
//           typename LeafLabel2>
// GenericBinaryParallelSplit<SeriesLabel2, ParallelLabel2, LeafLabel2> transform(
...
//                                                 SeriesLabel2,
//                                                 ParallelLabel2,
//                                                 LeafLabel2> const &transform_visitor) {
//
//   using ResultType = 
//     GenericBinarySPDecompositionTree<SeriesLabel2, ParallelLabel2, LeafLabel2>;
//
//   auto visitor = GenericBinarySPDecompositionTreeVisitor<
//     ResultType,
//     SeriesLabel,
//     ParallelLabel,
//     LeafLabel> 
...
//                                  ParallelLabel,
//                                  LeafLabel> const &s) -> ResultType {
//       return generic_binary_sp_tree_wrap_series_split(transform(s, transform_visitor));
//     },
//     [&](GenericBinaryParallelSplit<SeriesLabel,
//                                    ParallelLabel,
//                                    LeafLabel> const &s) -> ResultType {
//       return generic_binary_sp_tree_wrap_parallel_split(transform(s, transform_visitor));
//     },
//     [&](LeafLabel const &t) -> ResultType {
//       return generic_binary_sp_tree_wrap_leaf<SeriesLabel2, ParallelLabel2>(
//           transform_visitor.leaf_func(t));
//     },
//   };
//
