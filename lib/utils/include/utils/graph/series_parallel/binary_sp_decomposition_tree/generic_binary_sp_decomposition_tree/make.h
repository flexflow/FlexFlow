...
GenericBinarySPDecompositionTree<SeriesLabel, ParallelLabel, LeafLabel>
    make_generic_binary_series_split(
        ...
        GenericBinarySPDecompositionTree<SeriesLabel,
                                         ParallelLabel,
                                         LeafLabel> const &rhs) {
  return GenericBinarySPDecompositionTree<SeriesLabel,
                                          ParallelLabel,
                                          LeafLabel>{
      make_full_binary_tree_parent(
          make_generic_binary_series_split_label<SeriesLabel, ParallelLabel>(
              label),
          lhs.raw_tree,
          rhs.raw_tree),
  };
...
GenericBinarySPDecompositionTree<SeriesLabel, ParallelLabel, LeafLabel>
  ...
  return GenericBinarySPDecompositionTree<SeriesLabel,
                                          ...
                                          LeafLabel>{
      make_full_binary_tree_parent(
          make_generic_binary_parallel_split_label<SeriesLabel, ParallelLabel>(
              label),
          lhs.raw_tree,
          rhs.raw_tree),
  };
...
template <typename SeriesLabel, typename ParallelLabel, typename LeafLabel>
GenericBinarySPDecompositionTree<SeriesLabel, ParallelLabel, LeafLabel>
    make_generic_binary_sp_leaf(LeafLabel const &leaf) {
  return GenericBinarySPDecompositionTree<SeriesLabel,
                                          ParallelLabel,
                                          LeafLabel>{
      make_full_binary_tree_leaf<
          GenericBinarySPSplitLabel<SeriesLabel, ParallelLabel>>(leaf),
  };
}
