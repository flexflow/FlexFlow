#ifndef _FLEXFLOW_LIB_UTILS_INCLUDE_UTILS_GRAPH_SERIES_PARALLEL_BINARY_SP_DECOMPOSITION_TREE_GENERIC_BINARY_SP_DECOMPOSITION_TREE_FMT_H
...
std::string format_as(GenericBinarySeriesSplit<T> const &s) {
  return fmt::format("<GenericBinarySeriesSplit {} {}>",
                     get_left_child(s),
                     get_right_child(s));
}
...
std::string format_as(GenericBinaryParallelSplit<T> const &s) {
  return fmt::format("<GenericBinaryParallelSplit {} {}>",
                     get_left_child(s),
                     get_right_child(s));
}
