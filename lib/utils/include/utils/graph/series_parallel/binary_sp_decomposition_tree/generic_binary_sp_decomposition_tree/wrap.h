...
GenericBinarySPDecompositionTree<SeriesLabel, ParallelLabel, LeafLabel>
  ...
  return GenericBinarySPDecompositionTree<SeriesLabel, ParallelLabel, LeafLabel>{
    make_full_binary_tree_parent(
      /*label=*/make_generic_binary_series_split_label<SeriesLabel, ParallelLabel>(series_split.label),
...
GenericBinarySPDecompositionTree<SeriesLabel, ParallelLabel, LeafLabel>
  ...
  return GenericBinarySPDecompositionTree<SeriesLabel, ParallelLabel, LeafLabel>{
    make_full_binary_tree_parent(
      /*label=*/make_generic_binary_parallel_split_label<SeriesLabel, ParallelLabel>(parallel_split.label),
