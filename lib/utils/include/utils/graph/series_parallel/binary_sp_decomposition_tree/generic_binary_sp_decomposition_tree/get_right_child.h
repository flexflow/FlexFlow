#ifndef _FLEXFLOW_LIB_UTILS_INCLUDE_UTILS_GRAPH_SERIES_PARALLEL_BINARY_SP_DECOMPOSITION_TREE_GENERIC_BINARY_SP_DECOMPOSITION_TREE_GET_RIGHT_CHILD_H
...
GenericBinarySPDecompositionTree<SeriesLabel, ParallelLabel, LeafLabel>
    get_right_child(GenericBinarySeriesSplit<SeriesLabel, ParallelLabel, LeafLabel> const &s) {
  return s.post;
}

template <typename SeriesLabel, typename ParallelLabel, typename LeafLabel>
GenericBinarySPDecompositionTree<SeriesLabel, ParallelLabel, LeafLabel>
    get_right_child(GenericBinaryParallelSplit<SeriesLabel, ParallelLabel, LeafLabel> const &p) {
  return p.rhs;
}
