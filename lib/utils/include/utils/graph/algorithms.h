...
std::unordered_set<MultiDiEdge>
get_outgoing_edges(MultiDiGraphView const &, std::unordered_set<Node> const &);
std::unordered_set<DirectedEdge>
...
get_node_edges(UndirectedGraphView const &, std::unordered_set<Node> const &);
...
get_predecessors(MultiDiGraphView const &, std::unordered_set<Node> const &);
std::unordered_map<Node, std::unordered_set<Node>>
...
void export_as_dot(
    DotFile<Node> &, DiGraphView const &,
