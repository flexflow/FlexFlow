...
std::unordered_set<OutputMultiDiEdge> get_open_outputs(OpenMultiDiGraphView const &);
std::unordered_set<InputMultiDiEdge> get_open_inputs(OpenMultiDiGraphView const &);
