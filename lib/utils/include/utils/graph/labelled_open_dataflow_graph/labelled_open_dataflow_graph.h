...
struct LabelledOpenDataflowGraph : virtual public LabelledOpenDataflowGraphView<NodeLabel, ValueLabel> {
private:
...
public:
  ...
  LabelledOpenDataflowGraph &operator=(LabelledOpenDataflowGraph const &) = default;
