...
private:
  AdjacencyMultiDiGraph(NodeSource const &,
                        MultiDiEdgeSource const &,
                        std::unordered_map<Node, std::unordered_map<Node, std::unordered_set<MultiDiEdge>>> const &,
                        std::unordered_map<MultiDiEdge, std::pair<Node, Node>> const &);
private:
  NodeSource node_source;
  MultiDiEdgeSource edge_source;
  std::unordered_map<Node, std::unordered_map<Node, std::unordered_set<MultiDiEdge>>> adjacency;
