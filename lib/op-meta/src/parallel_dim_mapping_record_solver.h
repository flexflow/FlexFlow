 ...
 *          (partially tracked in https://github.com/flexflow/FlexFlow/issues/519).
 * @brief Helper functions for computing data dependencies of parallel operators. 
 *        Functions based on an incorrect abstraction that should eventually be removed 
 *        in favor of something like https://doi.org/10.1145/3302424.3303953
 */
...
/*   /1* void register_weight_parallel_dims(std::vector<std::pair<int, int>> mappings, *1/ */
/*   /1*                                    int input_idx = 0, *1/ */
/*   /1*                                    int weight_idx = 0); *1/ */

/*   /1* void register_output_parallel_dims(std::vector<std::pair<int, int>> mappings, *1/ */
/*   /1*                                    int input_idx = 0, *1/ */
