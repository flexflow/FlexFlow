...
PerfMetrics::PerfMetrics(int _train_all,
  ...
  : train_all(_train_all), train_correct(_train_correct), cce_loss(_cce_loss), mse_loss(_mse_loss), rmse_loss(_rmse_loss), mae_loss(_mae_loss), start_time(_start_time_micro), current_time(_current_time_micro)
{ }
