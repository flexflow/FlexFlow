...
void uniform_init_kernel(GenericTensorAccessorW const &, size_t seed,
                         float min_val, float max_val);
void glorot_uniform_init_kernel(GenericTensorAccessorW const &, size_t seed,
                                float scale_factor);
void norm_init_kernel(GenericTensorAccessorW const &, size_t seed, float mean,
                      float stddev);
...
void constant_init_kernel(TaskLocation const &, GenericTensorAccessorW const &,
                          DataTypeValue);
