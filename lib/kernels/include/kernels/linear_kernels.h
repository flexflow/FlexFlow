...
void forward_kernel(ffStream_t stream, LinearPerDeviceState const *m,
                    void const *input_ptr, void *output_ptr,
                    void const *filter_ptr, void const *bias_ptr, int in_dim,
                    int out_dim, int batch_size);
void backward_kernel(ffStream_t stream, LinearPerDeviceState const *m,
                     ...
                     void *bias_ptr, int in_dim, int out_dim, int batch_size);
