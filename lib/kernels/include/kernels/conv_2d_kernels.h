...
void init_kernel(Conv2DPerDeviceState *m, int input_w, int input_h, int input_c,
                 ...
                 float *forward_time = nullptr, float *backward_time = nullptr);

void forward_kernel(ffStream_t stream, Conv2DPerDeviceState const *m,
                    float const *input_ptr, float *output_ptr,
                    float const *filter_ptr, float const *bias_ptr);

void backward_kernel(ffStream_t stream, Conv2DPerDeviceState const *m,
