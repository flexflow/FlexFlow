...
TEST_SUITE(FF_TEST_SUITE) {
    ...
    TEST_CASE("Test cast kernel Int to Float") {
        ...
        void* int_data_ptr = int_allocator.allocate((100 * 100) * 
                                                     sizeof(int));
