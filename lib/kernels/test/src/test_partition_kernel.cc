...
TEST_SUITE(FF_TEST_SUITE) {
    TEST_CASE("Test Partition Forward and Backward") {
        ...
        RepartitionPerDeviceState state = Kernels::Repartition::init_kernel(handle, DataType::FLOAT);
        ...
        Kernels::Repartition::forward_kernel(stream, state, input_accessor, forward_output_accessor);
        ...
        Kernels::Repartition::backward_kernel(stream, state, forward_output_accessor, grad_accessor);
