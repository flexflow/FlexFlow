...
//   accessorR{DataType::FLOAT,ArrayShape(std::vector<std::size_t>{}), &dataR};
//   // Test get method
...
//   accessorW{DataType::INT32,ArrayShape(std::vector<std::size_t>{}), &dataW};
...
//   GenericTensorAccessorW
//   accessorW{DataType::INT64,ArrayShape(std::vector<std::size_t>{}), &dataW};
...
//   float dataW = 3.14f;
//   GenericTensorAccessorW
//   accessorW{DataType::FLOAT,ArrayShape(std::vector<std::size_t>{}), &dataW};
...
//   double dataW = 6.28;
//   GenericTensorAccessorW
//   accessorW{DataType::DOUBLE,ArrayShape(std::vector<std::size_t>{}), &dataW};
...
//   int32_t dataR = 67890;
//   GenericTensorAccessorR
//   accessorR{DataType::INT32,ArrayShape(std::vector<std::size_t>{}), &dataR};
//   // Test get_int32_ptr method
