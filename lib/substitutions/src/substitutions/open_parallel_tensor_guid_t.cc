...
open_parallel_tensor_guid_t open_parallel_tensor_guid_from_input(input_parallel_tensor_guid_t i) {
  return open_parallel_tensor_guid_t{OpenDataflowValue{i.raw_dataflow_graph_input}};
}
