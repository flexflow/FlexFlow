...
tl::optional<OperatorAttributeValue>
get_attribute(opmeta::AggregateSpecParams const &p, OperatorAttributeKey key) {
  switch (key) {
  default:
    return tl::nullopt;
  }
...
tl::optional<OperatorAttributeValue>
get_attribute(opmeta::BatchMatmulParams const &p, OperatorAttributeKey key) {
  switch (key) {
  default:
    return tl::nullopt;
  }
...
tl::optional<OperatorAttributeValue>
get_attribute(opmeta::ElementBinaryParams const &p, OperatorAttributeKey key) {
  switch (key) {
  default:
    return tl::nullopt;
  }
...
tl::optional<OperatorAttributeValue>
get_attribute(opmeta::ElementUnaryParams const &p, OperatorAttributeKey key) {
  switch (key) {
...
tl::optional<OperatorAttributeValue>
get_attribute(opmeta::RepartitionParams const &p, OperatorAttributeKey key) {
  switch (key) {
  case OperatorAttributeKey::PARALLEL_OP_DIM:
...
tl::optional<OperatorAttributeValue>
get_attribute(opmeta::OperatorParameters const &p, OperatorAttributeKey key) {
