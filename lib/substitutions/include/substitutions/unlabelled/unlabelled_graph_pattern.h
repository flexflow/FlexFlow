...
std::vector<PatternNode> get_topological_ordering(UnlabelledGraphPattern const &);

std::unordered_set<UpwardOpenPatternEdge> get_incoming_edges(UnlabelledGraphPattern const &, PatternNode const &);
std::unordered_set<DownwardOpenPatternEdge> get_outgoing_edges(UnlabelledGraphPattern const &, PatternNode const &);

UnlabelledGraphPattern get_subgraph(UnlabelledGraphPattern const &, std::unordered_set<PatternNode> const &);
