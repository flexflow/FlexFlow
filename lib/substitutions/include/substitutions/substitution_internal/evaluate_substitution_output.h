...
/**
 * @brief Takes a SubParallelComputationGraph and a PCGPatternMatch where a Substitution applies and 
 * evaluates the Substitution's OutputGraphExpr (producing another SubParallelComputationGraph) 
 * using the information from the matched nodes.
 *
 * @details Exists only to enable apply_substitution(SubParallelComputationGraph const &, Substitution const &, PCGPatternMatch const &)
 *
