...
TEST_SUITE(FF_TEST_SUITE) {
  TEST_CASE("pattern_split") {
    ...
    SUBCASE("apply_split") {
      ...
      SUBCASE("subpattern_1_outputs_to_subpattern_2_inputs") {
        bidict<PatternValue, PatternInput> result = split_result.subpattern_1_outputs_to_subpattern_2_inputs;
