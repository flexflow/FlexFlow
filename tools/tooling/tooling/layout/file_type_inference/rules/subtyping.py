...
rules: FrozenSet[Rule] = frozenset(
    {
        ...
        Rule(
            "subtyping.cpp_impl",
            HasAnyOfAttributes.from_iter([FileAttribute.CPP_SOURCE, FileAttribute.CPP_TEST]),
            FileAttribute.IMPL,
        ),
        Rule("subtyping.python", HasAttribute(FileAttribute.PYTHON_FF_TOOLS), FileAttribute.PYTHON),
    }
)
