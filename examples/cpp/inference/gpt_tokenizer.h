...
public:
    GPT_Tokenizer(const std::string & vocab_file, const std::string & merge_file, const std::string & bos_token_str="<s>", const std::string eos_token_str="</s>", const std::string pad_token_str="<pad>", const std::string unk_token_str="<unk>", const std::string mask_token_str="<mask>") {
...
private:
    ...
    std::unordered_set<wbigram_pair, hash_pair> get_pairs(std::vector<std::wstring> word);
