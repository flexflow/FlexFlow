...
std::wstring GPT_Tokenizer::utf8_to_wstring(const std::string& src){
    std::wstring_convert<std::codecvt_utf8<wchar_t>, wchar_t> converter;
    return converter.from_bytes(src);
};

std::u32string GPT_Tokenizer::utf8_to_utf32(const std::string& src){
    std::wstring_convert<std::codecvt_utf8<char32_t>, char32_t> converter;
    return converter.from_bytes(src);
};

std::string GPT_Tokenizer::wstring_to_utf8(const std::wstring& src){
    std::wstring_convert<std::codecvt_utf8<wchar_t>, wchar_t> converter;
    return converter.to_bytes(src);
};

std::string GPT_Tokenizer::utf32_to_utf8(const std::u32string& src){
    std::wstring_convert<std::codecvt_utf8<char32_t>, char32_t> converter;
    return converter.to_bytes(src);
};
...
std::vector<std::string> GPT_Tokenizer::split(const std::string &s, std::regex rgx){
...
std::string GPT_Tokenizer::strip(const std::string &inpt) {
...
std::unordered_set<wbigram_pair, hash_pair> GPT_Tokenizer::get_pairs(std::vector<std::wstring> word){
...
void GPT_Tokenizer::load_vocab(const std::string &vocab_file){
...
void GPT_Tokenizer::load_merge(const std::string &merge_file){
...
void GPT_Tokenizer::padding_encode_single_with_special_tokens(std::string str, size_t max_length, std::vector<int64_t> *input_ids, std::vector<int64_t> *mask_ids){
