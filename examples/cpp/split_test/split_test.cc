                    ...
                    Context ctx, Runtime *runtime) 
{
  ...
  Tensor input;
  { 
    const int dims[] = {1, ffConfig.batchSize, dims[0] };
  ...
  t = input;
  t = ff.dense(input, dims[1]);
  t = ff.relu(t);
  t1 = ff.dense(t, dims[2]);
  t2 = ff.dense(t, dims[2]);
  t = ff.add(t1, t2);
  t = ff.relu(t);
  t1 = ff.dense(t, dims[3]);
  t2 = ff.dense(t, dims[3]);
  t = ff.add(t1, t2);
  t = ff.relu(t);
  t = ff.softmax(t);
