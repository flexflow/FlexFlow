                    ...
                    Context ctx, Runtime* runtime)
{
  ...
  Tensor input;
  {
    const int dims[] = {ffConfig.batchSize, 1, 28, 28};
...
//-----------------------------------------------------------------
  Tensor t = ff.conv2d(input, 10, 5, 5, 1, 1, 0, 0);
  t = ff.pool2d(t, 2, 2, 2, 2, 0, 0, POOL_MAX, AC_MODE_RELU);

  t = ff.conv2d(t, 20, 5, 5, 1, 1, 0, 0);
  t = ff.pool2d(t, 2, 2, 2, 2, 0, 0, POOL_MAX, AC_MODE_RELU);

  t = ff.flat(t);

  t = ff.dense(t, 50, AC_MODE_RELU);
  t = ff.dense(t, 10);
