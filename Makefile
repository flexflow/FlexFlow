...
GEN_SRC		?= cnn.cc cnn_mapper.cc	$(APP).cc# .cc files
GEN_GPU_SRC	?= conv_2d.cu ops.cu pool_2d.cu batch_norm.cu linear.cu softmax.cu concat.cu cnn_helper.cu# .cu files
