...
6. `FF_USE_GASNET` is used to enable distributed run of FlexFlow. You can then set the preferred GASNET conduit with `FF_USE_GASNET`. For details, please refer to [MULTI-NODE.md](MULTI-NODE.md).
