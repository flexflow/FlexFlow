                                          ...
                                          size_t num_elements)
{
  ...
  ElementUnary::forward_kernel<T>(m, input_ptr, output_ptr, num_elements, stream);
}
                                   ...
                                   cudaStream_t stream)
{
  ...
  if (use_cudnn(m->op_type)) {
    ...
    elewise_unary_backward_kernel<T><<<GET_BLOCKS(num_elements), CUDA_NUM_THREADS, 0, stream>>>(
                                           ...
                                           size_t num_elements)
{
  cudaStream_t stream;
  checkCUDA(get_legion_stream(&stream));
  ElementUnary::backward_kernel<T>(m, input_ptr, input_grad_ptr, output_ptr, output_grad_ptr, num_elements, stream);
}
...
template void ElementUnary::forward_kernel_wrapper<double>(const ElementUnaryMeta* m, const double* input_ptr, double* output_ptr, size_t num_elements);
template void ElementUnary::forward_kernel_wrapper<int32_t>(const ElementUnaryMeta* m, const int32_t* input_ptr, int32_t* output_ptr, size_t num_elements);
template void ElementUnary::forward_kernel_wrapper<int64_t>(const ElementUnaryMeta* m, const int64_t* input_ptr, int64_t* output_ptr, size_t num_elements);

template void ElementUnary::backward_kernel_wrapper<float>(const ElementUnaryMeta* m, const float* input_ptr, float* input_grad_ptr, const float* output_ptr, const float* output_grad_ptr, size_t num_elements);
template void ElementUnary::backward_kernel_wrapper<double>(const ElementUnaryMeta* m, const double* input_ptr, double* input_grad_ptr, const double* output_ptr, const double* output_grad_ptr, size_t num_elements);
template void ElementUnary::backward_kernel_wrapper<int32_t>(const ElementUnaryMeta* m, const int32_t* input_ptr, int32_t* input_grad_ptr, const int32_t* output_ptr, const int32_t* output_grad_ptr, size_t num_elements);
template void ElementUnary::backward_kernel_wrapper<int64_t>(const ElementUnaryMeta* m, const int64_t* input_ptr, int64_t* input_grad_ptr, const int64_t* output_ptr, const int64_t* output_grad_ptr, size_t num_elements);
