...
__global__ void
    gb_inference_kernel(float const *input,
                        int const *exp_assign,
                        float **outputs,
                        int n,       // num experts
                        int k,       // chosen experts
...
/*static*/
void Group_by::inference_kernel_wrapper(GroupByMeta const *m,
                                        float const *input,
                                        int const *exp_assign,
                                        float **outputs,
                                        int n, // num experts
  ...
  // copy array of output tensor pointers to device memory. Each output tensor
  // is already in device memory, but the array containing the pointers to the
  // tensors is not
  cudaMemcpyAsync(m->dev_region_ptrs,
                  outputs,
                  n * sizeof(float *),
