                                      ...
                                      int data_dim)
{
  ...
  hipLaunchKernelGGL(gb_forward_kernel, GET_BLOCKS(batch_size*k*data_dim), min(CUDA_NUM_THREADS,(int)(batch_size*k*data_dim)), 0, stream, 
                                       ...
                                       int data_dim)
{
  ...
  hipLaunchKernelGGL(gb_backward_kernel, GET_BLOCKS(batch_size*k*data_dim), min(CUDA_NUM_THREADS,(int)(batch_size*k*data_dim)), 0, stream, 
