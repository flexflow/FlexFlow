 ...
 * ParallelDim array to record all the information regarding each dimension.
 */
...
void LinearParams::solve_dims(ParallelTensorShape const &input_shape,
  ...
  // sets the is_replica_dim field to true for the dimensions that are used to record the number of replicas
 ...
 *                          that dimension in the input, weight, (bias), or output tensor.
 */
...
/** @brief  Sets the size field of ParallelDim objects passed as arguments to the expected (non-replica) dimensions
 *          of the output, weights, and bias tensors. In addition, it sets the output_ndims, kernel_ndims and
 ...
 * @param[out]  kernel_dims   An array of ParallelDim objects representing the dimensions of the weights tensor
 * @param[out]  kernel_ndims  The number of dimensions (including the replica dimension(s)) of the weights tensor
 * @param[out]  bias_dims     An array of ParallelDim objects representing the dimensions of the bias tensor
 * @param[out]  bias_ndims    The number of dimensions (including the replica dimension(s)) of the bias tensor
 */
