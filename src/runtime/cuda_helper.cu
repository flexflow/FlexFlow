...
template __global__ void add_kernel<int32_t>(int32_t* dst, const int32_t* src, size_t size);
template __global__ void add_kernel<int64_t>(int64_t* dst, const int64_t* src, size_t size);
