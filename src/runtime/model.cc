                                        ...
                                        CommType comm_type)
{
  ...
  } else if (weight.type == CommType::NCCL) {
...
template Parameter FFModel::create_conv_weight<4>(Op* op, const int* dims, DataType data_type, Initializer* initializer, bool create_grad, CommType comm_type);
template Parameter FFModel::create_conv_weight<1>(Op* op, const int* dims, DataType data_type, Initializer* initializer, bool create_grad, CommType comm_type);

#define DIMFUNC(D1,D2) \
  template Parameter FFModel::create_linear_weight<D1, D2>(Op* op, const int* dims, DataType data_type, Initializer* initializer, bool create_grad, CommType comm_type);
  LEGION_FOREACH_NN(DIMFUNC)
#undef DIMFUNC
