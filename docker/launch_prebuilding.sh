...
docker create --name prelegion flexflow-"${gpu_backend}"-"${cuda_version}":latest
...
export LEGION_TARBALL="legion_ubuntu-20.04-${cuda_version}-${gpu_backend}-${python_version}.tar.gz"
