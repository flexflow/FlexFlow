...
OUT_DIR = os.path.join("align", "dropout", "out")
...
def run():
  ...
  dls = init_ffmodel(ffmodel, ((input_tensor_1, inp1),), label)
  assert len(dls) == 2
  inp1_dl, label_dl = dls

  # forward/backward pass
  run_fwd_bwd(ffmodel, ffconfig, (inp1_dl,), label_dl)
